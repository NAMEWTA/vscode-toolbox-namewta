...
| AC-001 至 AC-020                                                       | T-04 汇总       | Extension Host、手动 Gate、完整 CI/VSIX                  | T-04 Evidence       | planned  |
...
```text
WAVE_STATUS wave=4 ready=none active=none done=T-01,T-02,T-03 blocked=T-04
...
TICKET_STATUS id=T-04 state=blocked evidence=<Path>{roots.state}/specdev/changes/2026-08-09-review-all-git-changes/evidence/T-04.md</Path> deviation=D-T04-001-approved,D-T04-002-approved,D-R01-approved
BLOCKER id=B-T04-001 owner=user needed=运行物理键盘和辅助技术手动 Gate impact=AC-020;G-04
...
DECISION id=D-R01 owner=user status=approved impact=提交、推送并发布 `0.1.1` GitHub Release；不关闭 AC-020 或 G-04
```

- G-03 已关闭；T-04 的自动化验证、完整 `check:ci` 与 VSIX 已完成，路径偏差均已记录；仅人工辅助技术 Gate 使其保持 `blocked`。
...
- `B-T04-001` 需要在可控制的 Extension Development Host 中完成物理键盘和辅助技术手动验证。
